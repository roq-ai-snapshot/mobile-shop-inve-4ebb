...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'inventory-manager', 'sales-associate', 'accountant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Sales', path: '/sales', entity: 'sale', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
